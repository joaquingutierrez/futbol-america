...
const AutoGallery = ({ images }) => {
    ...
    return (
        <div ref={elementRef} className={`autoGallery ${transition ? "autoGallery-transition" : ""}`}>
            <img loading="lazy" className="autoGallery-img autoGallery-currentImg" src={images[currentIndex]} alt="" />
            <img loading="lazy" className="autoGallery-img autoGallery-nextImg" src={images[(currentIndex + 1) % images.length]} alt="" />
        </div>
    )
}
